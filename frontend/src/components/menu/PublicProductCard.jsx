  ...
  return (
    ...
    >
      <div className="px-2 pt-2 sm:px-0 sm:pt-0">
        <div className="mx-auto aspect-square w-[85%] overflow-hidden rounded-[calc(var(--menu-card-radius)-0.4rem)] bg-surface-container sm:w-full sm:rounded-none sm:aspect-[var(--menu-card-image-ratio,1/1)]">
