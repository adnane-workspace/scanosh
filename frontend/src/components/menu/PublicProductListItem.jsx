...
export default function PublicProductListItem({ product, onSelect, showDescription = true }) {
  ...
  return (
    <button
      ...
      className="flex w-full min-w-0 gap-2.5 bg-[var(--menu-card-bg)] p-2.5 text-start shadow-[var(--menu-card-shadow)] ring-1 ring-[var(--menu-card-ring)] transition-colors duration-200 animate-[fadeIn_0.35s_ease] active:bg-[#faf9f7] sm:gap-4 sm:p-4"
