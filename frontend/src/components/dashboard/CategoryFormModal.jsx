...
export default function CategoryFormModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center sm:p-6">
      ...
      <section className="relative z-10 max-h-[min(92vh,100dvh)] w-full overflow-y-auto rounded-t-2xl bg-surface-container-lowest p-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] shadow-xl sm:max-w-xl sm:rounded-2xl sm:p-6 sm:pb-6">
        ...
        <form onSubmit={onSubmit} className="grid gap-4">
          ...
          <div className="mt-2 flex flex-col-reverse gap-2 sm:flex-row sm:flex-wrap sm:gap-3">
            <button
              type="submit"
